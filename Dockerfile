...
# Install GeoIP:
RUN curl -L -O http://geolite.maxmind.com/download/geoip/database/GeoLite2-City.mmdb.gz /w3act/bin/GeoLite2-City.mmdb.gz && tar xzf /w3act/bin/GeoLite2-City.mmdb.gz && rm /w3act/bin/GeoLite2-City.mmdb.gz
