...
public class DuplicateUrls extends Controller {
    ...
    public static Result index() {
        return ok(
            duplicateurls.render(
                "DuplicateUrls", User.find.byId(request().username()), models.Target.findInvolving(), User.findAll()
            )
        );
    }
