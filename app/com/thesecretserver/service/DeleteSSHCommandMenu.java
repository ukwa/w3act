...
@XmlRootElement(name = "DeleteSSHCommandMenu")
public class DeleteSSHCommandMenu {

    protected String token;
    protected int sshCommandMenuId;
     ...
     * 
     */
    public int getSshCommandMenuId() {
     ...
     * 
     */
    public void setSshCommandMenuId(int value) {
